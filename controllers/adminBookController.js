...
exports.create = async (req, res) => {
  ...
  const book = await Book.create({ title, author, short_desc, description, price, compare_at_price: compare_at_price || null, file_url, preview_url, category_id: category_id || null, book_type_id: book_type_id || null, cover_url, is_published: is_published === 'on', slug: makeSlug(title) });
  res.redirect(`/admin/sach/${book.id}/noi-dung`);
};
...
exports.update = async (req, res) => {
  ...
  res.redirect(`/admin/sach/${req.params.id}/noi-dung`);
};
