...
router.get('/doc-sach-tai-lieu', requireRole('teacher'), adminOnlineBookController.list);
router.get('/doc-sach-tai-lieu/them-moi', requireRole('teacher'), adminOnlineBookController.newForm);
...
router.get('/sach/:id/noi-dung', requireRole('teacher'), courseController.bookContentPage);
...
router.post('/video/:id', requireRole('teacher'), uploadVideo.single('video_file'), contentController.updateVideo);
...
router.post('/tai-lieu/:id', requireRole('teacher'), uploadFile.single('file'), contentController.updateFile);
