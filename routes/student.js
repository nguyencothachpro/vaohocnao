...
router.get('/tai-khoan/ho-so', requireLogin, studentController.profileForm);
router.post('/tai-khoan/ho-so', requireLogin, studentController.profileSave);
...
router.get('/hoc/:id', studentController.watchLesson);
router.get('/sach/hoc/:id', requireLogin, studentController.bookLesson);
router.get('/tai-lieu/:id/doc', requireLogin, studentController.readLessonFile);
router.get('/tai-lieu/:id/file', requireLogin, studentController.lessonFileStream); // co the la bai preview => khong bat buoc dang nhap
