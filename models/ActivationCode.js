...
const ActivationCode = {
  ...
  async create(code, course_id, expires_at, extra = {}) {
    const r = await db.query(
      `INSERT INTO activation_codes (code,course_id,book_id,online_book_id,product_type,expires_at,duration_days)
       VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING *`,
      [code, course_id || null, extra.book_id || null, extra.online_book_id || null, extra.product_type || 'course', expires_at || null, extra.duration_days || null]
    );
    return r.rows[0];
  },
