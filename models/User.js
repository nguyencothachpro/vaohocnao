...
const User = {
  ...
  async updateStudentProfile(id, { name, phone, birth_date }) { await db.query('UPDATE users SET name=$1,phone=$2,birth_date=$3 WHERE id=$4',[name,phone||null,birth_date||null,id]); },
